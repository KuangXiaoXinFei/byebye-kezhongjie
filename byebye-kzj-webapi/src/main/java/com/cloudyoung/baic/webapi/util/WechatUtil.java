package com.cloudyoung.baic.webapi.util;

import com.alibaba.fastjson.JSON;
import com.cloudyoung.baic.common.utils.LogUtils;
import com.cloudyoung.baic.webapi.vo.wechat.AccessTokenResult;
import com.cloudyoung.baic.webapi.vo.wechat.WeChatConstant;
import com.cloudyoung.baic.webapi.vo.wechat.WxJsApiTicketResult;
...
public class WechatUtil {
    ...
    public static AccessTokenResult getAccessTokenByAppId(String appId, String appSecret) {
        ...
        String responseResult = com.cloudyoung.baic.common.utils.HttpUtils.get(url, null);
